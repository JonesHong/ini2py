...
class DevTools:
    ...
    def check_pypi_name(self, package_name="ini2py"):
        """檢查 PyPI 包名是否可用"""
    ...
    def get_package_stats(self, package_name="ini2py"):
        """獲取包的統計信息"""
    ...
    def validate_package(self):
        ...
        try:
            # 從 __init__.py 讀取版本
            init_file = self.root_dir / "ini2py" / "__init__.py"
...
def main():
    ...
    if command == "check-name":
        package_name = sys.argv[2] if len(sys.argv) > 2 else "ini2py"
