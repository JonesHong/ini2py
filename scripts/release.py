...
class ReleaseManager:
    def __init__(self):
        ...
        self.init_path = self.root_dir / "ini2py" / "__init__.py"
    ...
    def run_tests(self):
        ...
        #     # 運行 black 檢查
        #     result = subprocess.run(
        #         ["black", "--check", "ini2py/", "tests/"], capture_output=True, text=True
        #     )
        #     if result.returncode != 0:
        ...
        #     # 運行 flake8
        #     result = subprocess.run(
        #         ["flake8", "ini2py/", "tests/"], capture_output=True, text=True
        #     )
        #     if result.returncode != 0:
        #         print("❌ Flake8 檢查失敗:")
        #         print(result.stdout)
